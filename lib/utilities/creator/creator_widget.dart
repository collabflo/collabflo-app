...
class _CreatorWidgetState extends State<CreatorWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatorModel());
                ...
                child: Stack(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.network(
                        'https://images.unsplash.com/photo-1536344590992-7fd60353f543?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NTgzMDkyMzd8&ixlib=rb-4.1.0&q=80&w=1080',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          wrapWithModel(
                            model: _model.topCreatorModel,
                            updateCallback: () => safeSetState(() {}),
                            child: TopCreatorWidget(),
                          ),
                          wrapWithModel(
                            model: _model.responseFastModel,
                            updateCallback: () => safeSetState(() {}),
                            child: ResponseFastWidget(),
                          ),
                        ]
