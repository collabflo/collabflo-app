...
import '/creator/component/no_chats/no_chats_widget.dart';
                          ...
                          child: StreamBuilder<List<ProfilesRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ProfilesRecord> columnProfilesRecordList =
                                  snapshot.data!;
                              if (columnProfilesRecordList.isEmpty) {
                              ...
                              return SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: List.generate(
                                      columnProfilesRecordList.length,
                                      (columnIndex) {
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        TopBrandWidget(
                                                          key: Key(
                                                              'Key73y_${columnIndex}_of_${columnProfilesRecordList.length}'),
                                                        ),
                                                        NewJoinedWidget(
                                                          key: Key(
                                                              'Key8ip_${columnIndex}_of_${columnProfilesRecordList.length}'),
                                                        ),
                                                      ].divide(
                                                          SizedBox(width: 5.0)),
                                                    ),
