...
import 'creator_nav_bar_model.dart';
export 'creator_nav_bar_model.dart';

class CreatorNavBarWidget extends StatefulWidget {
  const CreatorNavBarWidget({
    super.key,
  ...
  @override
  State<CreatorNavBarWidget> createState() => _CreatorNavBarWidgetState();
}

class _CreatorNavBarWidgetState extends State<CreatorNavBarWidget> {
  late CreatorNavBarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatorNavBarModel());
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: AnimatedContainer(
        ...
        curve: Curves.linear,
        width: FFAppState().isDrawerOpen == false ? 78.0 : 272.0,
              ...
              Padding(
                ...
                child: FutureBuilder<List<ProfilesRecord>>(
                  future: FFAppState().profileCache(
                    requestFn: () => queryProfilesRecordOnce(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ProfilesRecord> accountRowProfilesRecordList =
                        snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final accountRowProfilesRecord =
                        accountRowProfilesRecordList.isNotEmpty
                            ? accountRowProfilesRecordList.first
                            : null;
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                ...
                                image: CachedNetworkImageProvider(
                                  accountRowProfilesRecord!.profilePic,
                                ),
                              ),
                                ...
                                children: [
                                  Text(
                                    valueOrDefault<String>(
                                      accountRowProfilesRecord.displayName,
                                      'null',
                                    ),
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      accountRowProfilesRecord.username,
                                      'Null',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: () {
                                  if (_model.mouseRegionHovered3 == true) {
                                    return Color(0xFF2A2828);
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: () {
                                  if (_model.mouseRegionHovered4 == true) {
                                    return Color(0xFF2A2828);
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: () {
                                  if (_model.mouseRegionHovered5 == true) {
                                    return Color(0xFF2A2828);
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: () {
                                  if (_model.mouseRegionHovered6 == true) {
                                    return Color(0xFF2A2828);
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: () {
                                  if (_model.mouseRegionHovered7 == true) {
                                    return Color(0xFF2A2828);
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: () {
                                  if (_model.mouseRegionHovered8 == true) {
                                    return Color(0xFF2A2828);
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: () {
                                  if (_model.mouseRegionHovered9 == true) {
                                    return Color(0xFF2A2828);
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: () {
                                  if (_model.mouseRegionHovered10 == true) {
                                    return Color(0xFF2A2828);
