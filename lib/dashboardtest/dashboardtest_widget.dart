...
import 'dashboardtest_model.dart';
export 'dashboardtest_model.dart';

class DashboardtestWidget extends StatefulWidget {
  const DashboardtestWidget({super.key});

  static String routeName = 'dashboardtest';
  static String routePath = '/dashboardtest';
...
class _DashboardtestWidgetState extends State<DashboardtestWidget>
  ...
  late DashboardtestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardtestModel());
