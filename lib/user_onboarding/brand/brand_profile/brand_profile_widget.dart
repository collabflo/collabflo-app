...
export 'brand_profile_model.dart';

class BrandProfileWidget extends StatefulWidget {
  const BrandProfileWidget({
    super.key,
    this.fullName,
  });
  ...
  static String routeName = 'brandProfile';
  static String routePath = '/brandProfile';

  @override
  State<BrandProfileWidget> createState() => _BrandProfileWidgetState();
}

class _BrandProfileWidgetState extends State<BrandProfileWidget> {
  late BrandProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BrandProfileModel());
    ...
    _model.contactNameFocusNode!.addListener(() => safeSetState(() {}));
                                            ...
                                            if (selectedMedia != null &&
                                                selectedMedia.every((m) =>
                                                    validateFileFormat(
                                                        ...
                                                        context))) {
                                              safeSetState(() => _model
                                                      .isDataUploading_uploadDataBrand =
                                                  true);
                                              ...
                                              try {
                                                ...
                                                _model.isDataUploading_uploadDataBrand =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataBrand =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataBrand =
                                                      downloadUrls.first;
                                                });
                                              } else {
                                                safeSetState(() {});
                                              ...
                                              Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    hintText:
                                                        'e.g. Sustainable fashion brand creating eco-friendly clothing for modern lifestyles.',
                                                    hintStyle:
                                                        FlutterFlowTheme.of(
                                                                context)
                                                            .labelMedium
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              await _model.users!.reference
                                                  .update(createUsersRecordData(
                                                phoneNumber: _model
                                                    .phoneTextController.text,
                                                photoUrl: _model
                                                    .uploadedFileUrl_uploadDataBrand,
                                                gender:
                                                    _model.genderDropDownValue,
                                                address: _model
                                              ...
                                              await _model.profiles!.reference
                                                  .update(
